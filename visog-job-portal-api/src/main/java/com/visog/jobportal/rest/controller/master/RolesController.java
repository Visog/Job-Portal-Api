...
public class RolesController {
	 ...
	 * 
	 * @Path("/roles") public JobPortalResponse createRole(RolesReq req) {
	 * 
	...
	public JobPortalResponse createRole(RolesReq req) {
		...
		if (service.saveRole(req)) {
			jobPortalResponse.setMessage("Role saved succcessfully");
			jobPortalResponse.setStatus(Status.STATUS_SUCCESS);
			jobPortalResponse.setStatusCode(Status.STATUSCODE_SUCCESS);
		} else {
			jobPortalResponse.setMessage("Role data already exist");
	 ...
	 * @Consumes(MediaType.APPLICATION_JSON)
	 * 
	 * @Path("/roles/{roleId}") public JobPortalResponse
	 * updateRole(@PathParam("roleId") String roleId, RolesReq req) {
	 * 
	...
	public JobPortalResponse updateRole(@PathParam("roleId") String roleId, RolesReq req) {
		JobPortalResponse jobPortalResponse = new JobPortalResponse();
		if (service.updateRole(req, roleId)) {
